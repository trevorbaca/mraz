...
def main():
    layout = baca.make_layout(
        ...
        overrides=(
            baca.region(8, (1, 16)),
            baca.region(16, (1, 24)),
            baca.region((31, 32), (1, 4)),
            baca.region((34, 50), (1, 12)),
            baca.region([35, 38], (1, 4)),
            baca.region((51, 65), (1, 24)),
            baca.region((66, 67), (1, 4)),
            baca.region((68, 69), (1, 32)),
            baca.region(70, (1, 4)),
            baca.region((71, 72), (1, 32)),
            baca.region((73, 75), (1, 4)),
            baca.region([77, 82], (1, 8)),
            baca.region((83, 96), (1, 28)),
            baca.region((98, 108), (1, 48)),
            baca.region([4, 6, 9, 23, 25, 28, 54, 84, 88, 90, 97], (1, 4)),
        ),
    )
