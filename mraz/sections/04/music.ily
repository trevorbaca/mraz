...
number.4.RH.Music.1 = {
    ...
    % OPEN_BRACKETS:
    {
        ...
        \times 5/4
        {
            ...
            % BEFORE:
            % COMMANDS:
              %! baca.text_script_up_function(1)
            ...
            % AFTER:
            % COMMANDS:
              %! baca.text_script_up_function(2)
    ...
    % OPEN_BRACKETS:
    {
        ...
        \scaleDurations #'(1 . 1)
        {
            ...
            \override Rest.transparent = ##t
              %! baca.sustain_pedal_staff_padding_function(1)
            ...
            \revert Rest.transparent
              %! baca.sustain_pedal_staff_padding_function(2)
