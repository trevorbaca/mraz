...
def make_empty_score(first_measure_number, previous_persistent_indicators):
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<7, 6>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<7, 9, 1>", "PC<11, 8, 9>"]
        tuplets = []
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<1, 9, 8>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<2, 10>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<11, 1, 5>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<3, 0, 1, 3>"]
        tuplet = baca.from_collection(collections[0], [1, -15], 32)
        accumulator(
            library.lh_v5,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<0, 2>"]
        tuplet = baca.from_collection(collections[0], [6, -1], 32)
        accumulator(
            library.lh_v5,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<6, 4, 3>", "PC<2, 3, 5>"]
        tuplets = []
        for collection in collections:
            tuplet = baca.from_collection(collection, [4, -1], 32, 1)
            tuplets.append(tuplet)
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<9, 7>"]
        tuplet = baca.from_collection(collections[0], [1, -15], 32)
        accumulator(
            library.lh_v5,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<11, 9, 5, 4>"]
        tuplet = baca.from_collection(collections[0], [6, -1], 32)
        accumulator(
            library.lh_v5,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<6, 10, 8>"]
        tuplet = baca.from_collection(collections[0], [4, -1], 32, 1)
        accumulator(
            library.lh_v5,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<8, 0, 10>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<10, 0, 4>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<7, 5, 1>"]
        tuplet = baca.from_collection(collections[0], [1, -3], 16, 4)
        accumulator(
            library.lh_v6,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<2, 4, 8, 6>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<4, 5, 7>"]
