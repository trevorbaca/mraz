...
segment.03.RH.Voice.I = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (8) \hspace #1 "4.5.R.1" ] }
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (9) \hspace #1 "4.5.R.2" ] }
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (10) \hspace #1 "4.5.R.3" ] }
            %! baca.ottava()
...
segment.03.RH.Voice.II = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (2) \hspace #1 "2.2.R.1.1" ] }
            [
            %! baca.slur()
            %! baca.SpannerIndicatorCommand._call(2)
            %! SPANNER_START
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (4) \hspace #1 "2.2.R.1.1-2" ] }
            [
            %! baca.slur()
            %! baca.SpannerIndicatorCommand._call(2)
            %! SPANNER_START
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (7) \hspace #1 "2.2.R.1.1-4" ] }
            [
            %! baca.slur()
            %! baca.SpannerIndicatorCommand._call(2)
            %! SPANNER_START
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (11) \hspace #1 "4.5.L.1-4" ] }
            %! EXPLICIT_DYNAMIC_COLOR
            %! _treat_persistent_wrapper(1)
            %! baca.hairpin()
            %! baca.PiecewiseCommand._call(2)
...
segment.03.RH.Voice.III = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (5) \hspace #1 "4.1.R.1" ] }
...
segment.03.LH.Voice.V = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_LABEL
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (6) \hspace #1 "4.1.L.1" ] }
