...
accumulator(
    ...
    baca.pfmaker([4, -1], 32, treatments=[1]),
    baca.register(-39, -27),
    baca.rest_up(),
    signature=4,
...
accumulator(
    ...
    baca.pfmaker([4, -4], 16, treatments=[-4]),
    baca.dynamic("f"),
    baca.register(-39),
    anchor=baca.anchor(
        "lh_v5",
...
accumulator(
    "lh_v6",
    collections["stage 3"]["lh"].next(),
    baca.pfmaker([1, -3], 16, treatments=[4]),
...
accumulator(
    "lh_v6",
    collections["stage 3"]["lh"].next(),
    baca.pfmaker([2], 16, treatments=[2]),
    baca.register(-39),
    anchor=baca.anchor(
        "lh_v5",
        baca.rest(33),
...
accumulator(
    ...
    baca.pfmaker([2, -4], 16, treatments=[-6]),
