...
accumulator(
    ...
    baca.pitch_first_assignment_command([6, -1], 32),
    baca.dynamic("ppp"),
    baca.dynamic_up(),
    baca.register(-27, -39),
    signature=4,
...
accumulator(
    ...
    baca.pitch_first_assignment_command([4, -1], 32, treatments=[1]),
    baca.register(-39, -27),
    baca.rest_up(),
    signature=4,
...
accumulator(
    "lh_v5",
    collections["stage 3"]["rh"].next(),
    baca.pitch_first_assignment_command([1, -15], 32),
    baca.register(-39),
    signature=2,
...
accumulator(
    "lh_v5",
    collections["stage 3"]["rh"].next(),
    baca.pitch_first_assignment_command([4, -1], 32),
    baca.register(-39, -27),
    signature=4,
...
accumulator(
    ...
    baca.pitch_first_assignment_command([4, -4], 16, treatments=[-4]),
    baca.dynamic("f"),
    baca.register(-39),
    anchor=baca.anchor(
        "lh_v5",
...
accumulator(
    "lh_v6",
    collections["stage 3"]["lh"].next(),
    baca.pitch_first_assignment_command([1, -3], 16, treatments=[4]),
...
accumulator(
    "lh_v6",
    collections["stage 3"]["lh"].next(),
    baca.pitch_first_assignment_command([2], 16, treatments=[2]),
    baca.register(-39),
    anchor=baca.anchor(
        "lh_v5",
        baca.rest(33),
...
accumulator(
    ...
    baca.pitch_first_assignment_command([2, -4], 16, treatments=[-6]),
