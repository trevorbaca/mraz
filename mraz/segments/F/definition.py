...
accumulator(
    ...
    baca.pfmaker([2], 16, treatments=[-2, -2, 0]),
    baca.register(24, 0),
    baca.nest("-1/4"),
    baca.imbricate(
        "rh_v2",
...
accumulator(
    "rh_v3",
    collections["stage 2"]["rh"].next(5),
    baca.pfmaker([2], 16, treatments=[-2, 0, -2]),
...
accumulator(
    "rh_v3",
    collections["stage 2"]["rh"].next(5),
    baca.pfmaker([2], 16, treatments=[0, -2, -2]),
    baca.register(24, 0),
    baca.nest("-3/8"),
    baca.imbricate(
        "rh_v2",
...
accumulator(
    ...
    baca.pfmaker([3, -3], 16, affix=baca.rests_around([8, 8, 8], [6])),
    baca.clef("bass"),
    baca.dynamic("p"),
    baca.slur(map=baca.tuplets()),
    baca.register(6, -24),
...
accumulator(
    "lh_v4",
    collections["stage 2"]["lh"].next(),
    baca.pfmaker([3, -1], 16, affix=baca.rests_before([8, 8])),
    baca.dynamic("p"),
    baca.slur(map=baca.tuplets()),
    baca.register(6, -24),
    baca.slur_down(),
...
accumulator(
    "lh_v4",
    collections["stage 2"]["lh"].next(),
    baca.pfmaker([3], 16, affix=baca.rests_around([3], [4, 4, 4])),
    rmakers.beam_groups(),
    rmakers.beam(),
    baca.slur(map=baca.tuplets()),
    baca.register(-6, -48),
...
accumulator(
    "lh_v4",
    collections["stage 2"]["lh"].next(),
    baca.pfmaker([2], 16, affix=baca.rests_before([14])),
    rmakers.beam_groups(),
    rmakers.beam(),
    baca.dynamic("p"),
    baca.slur(map=baca.tuplets()),
