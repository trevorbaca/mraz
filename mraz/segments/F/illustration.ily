...
F_RHVoiceIII = {
    ...
    % [F RHVoiceIII measure 109]                                 %! SM4
    s1 * 3/16
    
    % [F RHVoiceIII measure 110]                                 %! SM4
    s1 * 5/8
    
    % [F RHVoiceIII measure 111]                                 %! SM4
    s1 * 1/8
...
F_LHVoiceII = {
    ...
    % [F LHVoiceII measure 109]                                  %! SM4
    s1 * 3/16
    
    % [F LHVoiceII measure 110]                                  %! SM4
    s1 * 5/8
    
    % [F LHVoiceII measure 111]                                  %! SM4
    s1 * 1/8
...
F_LHVoiceVInserts = {
    ...
    s1 * 329/272
    {
        ...
        \times 15/17 {
            ...
            \scaleDurations #'(1 . 1) {
                ...
                % [F LHVoiceVInserts measure 104]                %! SM4
                \override Stem.direction = #up                   %! OC1
                \set stemLeftBeamCount = 2
                \set stemRightBeamCount = 2
                b'16
    ...
    % [F LHVoiceVInserts measure 109]                            %! SM4
    s1 * 3/16
    
    % [F LHVoiceVInserts measure 110]                            %! SM4
    s1 * 5/8
...
F_LHResonanceVoice = {
    ...
    % [F LHResonanceVoice measure 109]                           %! SM4
    s1 * 3/16
    
    % [F LHResonanceVoice measure 110]                           %! SM4
    s1 * 5/8
    
    % [F LHResonanceVoice measure 111]                           %! SM4
