...
accumulator(
    'rh_v3',
    collections['stage 1']['rh'].next(),
    baca.pitch_first_assn([-4, 2, -4, 4], 16),
    rmakers.beam_groups(),
    rmakers.unbeam(),
    baca.register(12, -12),
    baca.stem_up(),
...
accumulator(
    'lh_v5',
    collections['stage 1']['lh'].next(),
    baca.pitch_first_assn([3, -1, 3, -1, -4, 3, -1], 16),
    rmakers.beam_groups(),
    rmakers.unbeam(),
    baca.register(-6, 6),
...
accumulator(
    'lh_v5',
    collections['stage 1']['lh'].next(),
    baca.pitch_first_assn([3, -1, -4, 3, -1, 3, -1], 16),
    rmakers.beam_groups(),
    baca.dynamic('f'),
    rmakers.unbeam(),
    baca.register(-6, 6),
