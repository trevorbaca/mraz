...
accumulator(
    ...
    baca.pitch_first_assignment([3], 16, affix=baca.rests_around([1], [8])),
...
accumulator(
    "lh_v5",
    collections["stage 2"]["lh"].next(),
    baca.pitch_first_assignment([1], 16, affix=baca.rests_after([3, 16])),
    baca.bass_to_octave(3),
    signature=4,
...
accumulator(
    "lh_v5",
    [chord_1_lower.chord()],
    baca.pitch_first_assignment([1], 16, affix=baca.rests_after([3])),
    baca.cross_staff(),
    baca.dynamic("mp"),
...
accumulator(
    "lh_resonance",
    [{-35, -23}],
    baca.pitch_first_assignment([8], 16, affix=baca.skips_before([4])),
    baca.nest("+1/4"),
...
accumulator(
    "lh_resonance",
    [{-35, -23}],
    baca.pitch_first_assignment([16], 16),
    signature=4,
...
accumulator(
    ...
    baca.pitch_first_assignment([2], 16, affix=baca.rests_around([4], [4])),
    rmakers.beam_groups(),
...
accumulator(
    ...
    baca.pitch_first_assignment([6], 16, affix=baca.rests_before([2])),
    baca.slur(map=baca.ntruns()),
    baca.register(-12, 0),
    signature=4,
...
accumulator(
    ...
    baca.pitch_first_assignment([2], 16),
    rmakers.beam_groups(),
    rmakers.beam(),
    baca.slur(map=baca.tuplets().map(baca.tleaves()).nontrivial()),
    baca.register(24),
...
accumulator(
    "lh_v5",
    collections["stage 4"]["lh"].next(2),
    baca.pitch_first_assignment([2], 16, affix=baca.rests_around([4], [2])),
    baca.register(0, -12),
    rmakers.beam_groups(),
    baca.nest("+2/16"),
    baca.imbricate(
...
accumulator(
    "lh_v5",
    collections["stage 4"]["lh"].next(),
    baca.pitch_first_assignment([2], 16, affix=baca.rests_around([2], [6])),
    baca.slur(map=baca.ntruns()),
    baca.register(-12, 0),
    signature=4,
...
accumulator(
    ...
    baca.pitch_first_assignment([2, -14], 16),
