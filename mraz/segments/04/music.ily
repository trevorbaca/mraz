...
segment.04.RH.Voice.II = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_NAME
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (2) \hspace #1 "4.6.R.2" ] }
...
segment.04.RH.Voice.III = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_NAME
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (1) \hspace #1 "4.1.R.1" ] }
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_NAME
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (3) \hspace #1 "4.1.R.2" ] }
...
segment.04.LH.Voice.IV = {
    ...
    %! baca.music()
    {
        ...
        %! baca.music()
        {
            ...
            %@% - \tweak color #blue
            %! FIGURE_NAME
            %@% - \markup \fontsize #2 \concat { [ \raise #0.25 \fontsize #-2 (4) \hspace #1 "5.2.L.1" ] }
            %! baca.slur()
            %! baca.SpannerIndicatorCommand._call(2)
            %! SPANNER_START
            (
