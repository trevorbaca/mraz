...
C_RH_Voice_III = {                                                             %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7)
        ...
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):INVISIBLE_MUSIC:HIDDEN_NOTE
            ...
            b'1 * 21/16                                                        %! baca.SegmentMaker._make_multimeasure_rest_container(1):HIDDEN_NOTE
        ...
        {                                                                      %! baca.SegmentMaker._make_multimeasure_rest_container(6)
            ...
            s1 * 21/16                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(5)
...
C_LH_Voice_V = {                                                               %! abjad.Path.extern()
    ...
    <<                                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(7)
        ...
        %@% \baca-invisible-music                                              %! baca.SegmentMaker._make_multimeasure_rest_container(3):INVISIBLE_MUSIC:HIDDEN_NOTE
            \baca-not-yet-pitched-coloring                                     %! baca.SegmentMaker._color_not_yet_pitched():NOT_YET_PITCHED
            d1 * 21/16                                                         %! baca.SegmentMaker._make_multimeasure_rest_container(1):HIDDEN_NOTE
        %@% ^ \baca-duration-multiplier-markup #"21" #"16"                     %! baca.SegmentMaker._label_duration_multipliers():DURATION_MULTIPLIER
