...
maker(
    ...
    baca.metronome_mark_new('112', selector=baca.leaf(4)),
    baca.metronome_mark_new('84', selector=baca.leaf(5)),
    baca.metronome_mark_new(baca.Accelerando(), selector=baca.leaf(5)),
    baca.metronome_mark_new('112', selector=baca.leaf(14)),
    baca.metronome_mark_new('112', selector=baca.leaf(19)),
    baca.metronome_mark_new(baca.Ritardando(), selector=baca.leaf(19)),
    baca.metronome_mark_new('84', selector=baca.leaf(22)),
    baca.metronome_mark_new('112', selector=baca.leaf(23)),
    baca.metronome_mark_new(baca.Ritardando(), selector=baca.leaf(23)),
    baca.metronome_mark_new('84', selector=baca.leaf(27)),
    baca.metronome_mark_new('112', selector=baca.leaf(29)),
    baca.metronome_mark_new(baca.Ritardando(), selector=baca.leaf(29)),
    baca.metronome_mark_new('84', selector=baca.leaf(31)),
    baca.metronome_mark_new('112', selector=baca.leaf(32)),
    baca.metronome_mark_new(baca.Ritardando(), selector=baca.leaf(32)),
    baca.metronome_mark_new('84', selector=baca.leaf(36)),
    )
