...
accumulator(
    ...
    baca.map(baca.slur(), baca.ntruns()),
    baca.register(36, 22),
    baca.slurs_down(selector=baca.leaf(0)), # lilypond error when slur is up
    counts=[2],
