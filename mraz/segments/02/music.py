...
figures(
    "lh_v5",
    collections_8["stage 3"]["rh"].next(2),
...
figures(
    "lh_v5",
    collections_8["stage 3"]["rh"].next(exhausted=True),
    baca.figure([4, -1], 32, treatments=[1]),
    baca.register(-39, -27),
    signature=4,
...
figures(
    "lh_v6",
    collections_8["stage 3"]["lh"].next(exhausted=True),
