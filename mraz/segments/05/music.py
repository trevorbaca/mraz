...
figures(
    "rh_v3",
    collections_6.one.rh.next(exhausted=True),
    baca.figure([1], 8, treatments=[1]),
    baca.register(12, 24),
    baca.staccato(baca.selectors.pheads()),
    baca.tenuto(baca.selectors.pheads()),
...
figures(
    "lh_v4",
    collections_6.one.lh.next(exhausted=True),
    baca.figure([2, -1], 32),
    baca.register(12, 0),
    baca.tenuto(baca.selectors.pheads()),
