...
accumulator(
    ...
    baca.anchor('RHVoiceThree', baca.note(0)),
    baca.dynamic('f'),
    baca.flags(),
    baca.register(-6, 6),
...
maker(
    baca.scope('LHResonanceVoice', 20, Infinity),
    baca.map(baca.tie(repeat=True), baca.qruns()),
    )
