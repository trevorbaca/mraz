...
accumulator(
    'RH Voice 5',
    [chord_1_upper.chord()],
    baca.anchor('LHVoice 5', baca.chord(-1)),
    baca.flags(),
    baca.rests_after([3]),
    counts=[1],
...
accumulator(
    'LH Resonance Voice',
    [{-35, -23}],
    baca.anchor('LHVoice 5', baca.rest(24)),
    baca.flags(),
    baca.nest('+1/4'),
    baca.skips_before([4]),
...
accumulator(
    'LH Resonance Voice',
    [{-33, -21}],
    baca.anchor('LHVoice 5', baca.rest(32)),
    baca.flags(),
    baca.nest('+1/4'),
    baca.skips_before([4]),
    color_unregistered_pitches=False,
...
accumulator(
    ...
    baca.anchor('LHVoice 5', baca.rest(-8)),
    baca.beam_runs(hide_nibs=True),
    baca.imbricate(
        'RH Voice 2',
        [9, 10, 10, 1, 0],
...
maker(
    baca.scope('LHVoice 5', 7, 15),
    baca.marcati(),
    baca.rests_up(),
    )

maker(
    baca.scope('LHVoice 5', 16, Infinity),
