...
accumulator(
    ...
    baca.flags(),
    baca.line_break(),
    baca.make_markup('(temporary line-break to avoid collision with next chord)'),
...
accumulator(
    ...
    baca.make_markup('(ottava brackets always govern all voices on staff)'),
    baca.register(36, 22),
    baca.rests_around([2], [6]),
...
accumulator(
    ...
    baca.hairpin('f < ff'),
    baca.line_break(baca.leaf(-1)),
    baca.make_markup('(temporary line-break)'),
    baca.proportional_notation_duration((1, 32)),
    baca.register(10, 36),
    baca.map(baca.slur(), baca.ntruns()),
    baca.slurs_up(),
...
accumulator(
    ...
    baca.dynamic('mp'),
    baca.flags(),
    baca.make_markup('(memory of before)'),
    baca.proportional_notation_duration((1, 16)),
    baca.register(12, -12),
    baca.resume(),
    baca.text_scripts_up(),
