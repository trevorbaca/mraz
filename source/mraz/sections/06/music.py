...
def make_empty_score(first_measure_number, previous_persistent_indicators):
    ...
    def block():
        ...
        rmakers.attach_beams_to_runs_by_leaf_list(groups)
    ...
    def block():
        ...
        baca.override.slur_direction_down(tuplet)
        baca.label_figure(tuplet, "5.2.L.1", accumulator)

    @baca.call
    def block():
        collections = section_5.stage_2.lh[1:2]
        assert library.summarize(collections) == ["PC<8, 4, 10, 1>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<11, 7>"]
        tuplet = baca.from_collection(collections[0], [3, -1], 16)
        accumulator(
            library.lh_v4,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<11, 3, 1, 8>"]
        tuplet = baca.from_collection(collections[0], [3, -1], 16)
        accumulator(
            library.lh_v4,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<4, 10>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<1, 11, 7>"]
        tuplet = baca.from_collection(collections[0], [3], 16)
        accumulator(
            library.lh_v4,
            [tuplet],
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<1, 8, 4>"]
    ...
    def block():
        ...
        assert library.summarize(collections) == ["PC<10, 1, 11, 7>"]
        tuplet = baca.from_collection(collections[0], [2], 16)
        accumulator(
            library.lh_v4,
            [tuplet],
    ...
    rmakers.tweak_skip_filled_tuplets_stencil_false(tuplets)
...
def make_layout(environment):
    breaks = baca.layout.Breaks(
        baca.layout.Page(
            ...
            baca.layout.System(4, y_offset=65, distances=(17, 18)),
            baca.layout.System(6, y_offset=130, distances=(17, 18)),
            baca.layout.System(8, y_offset=195, distances=(17, 18)),
        ),
        baca.layout.Page(
            2,
            baca.layout.System(10, y_offset=0, distances=(17, 15)),
            baca.layout.System(12, y_offset=65, distances=(17, 15)),
            baca.layout.System(15, y_offset=130, distances=(17, 18)),
        ),
    )
    spacing = baca.layout.Spacing(
        ...
        strict_overrides=(
            ...
            baca.layout.Override([3, 7, 9, 16], (1, 4)),
        ),
    )
